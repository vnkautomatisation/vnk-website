...
const SETTINGS: SeedSetting[] = [
  ...
  { category: "signature", key: "provider", value: "dropbox_sign", label: "Fournisseur de signature", description: "dropbox_sign | hellosign | internal", sortOrder: 10 },
  ...
  { category: "integrations", key: "dropbox_sign_api_key", value: "", type: "secret", label: "Dropbox Sign : clé API", isSecret: true, sortOrder: 50 },

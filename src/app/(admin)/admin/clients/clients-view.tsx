...
export function ClientsView({
  ...
  const handleCreate = async (): Promise<{ success: boolean; error?: string }> => {
    if (!newName.trim() || !newEmail.trim()) {
      return { success: false, error: "Nom et courriel requis" };
    }
    try {
      ...
      return { success: false, error: data.error || "Erreur lors de la creation" };
    } catch {
  ...
  const columns: Column<Client>[] = [
    {
      ...
      accessor: (r) => (
        <button
          onClick={() => { setCdpClientId(r.id); setCdpOpen(true); }}
    ...
    },
    {
      ...
      header: "Statut",
      accessor: (r) => (
        <StatusBadge status={r.archived ? "cancelled" : r.isActive ? "active" : "paused"} />
      ),
    },
    {
      key: "mandates",
      header: "Mandats",
      accessor: (r) => r.mandateCount,
      sortable: true,
      sortBy: (r) => r.mandateCount,
      hiddenOnMobile: true,
    },
    {
      key: "last_login",
      header: "Connexion",
      accessor: (r) => (r.lastLogin ? formatDate(new Date(r.lastLogin)) : "Jamais"),
      hiddenOnMobile: true,
    },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-sm">
          ...
          <Input
            ...
            placeholder="Nom, entreprise, courriel, ville..."
            className="pl-9"
          />
        </div>
      ...
      <CreateModal
        ...
        description="Ajoutez un nouveau client a votre base"
        icon={UserPlus}
        accent="bg-blue-500"
      ...
      >
        <div className="space-y-4">
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="new-email">Courriel *</Label>
              <Input
                id="new-email"
                type="email"
                value={newEmail}
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="new-phone">Telephone</Label>
              <Input
                id="new-phone"
                value={newPhone}

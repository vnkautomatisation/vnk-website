  ...
  if (contract) {
    await prisma.notification.create({
      data: {
        ...
        body: t("hr_contracts_veuillez_consulter_et_signer_votre_contrat_p0", { p0: contract.title }),
      ...
      hrAdmins.map((a) =>
        prisma.notification.create({
          data: {
            ...
            body: t("hr_contracts_p0_a_signe_p1_a_signer_en_tant", { p0: signed.admin.fullName || signed.admin.email, p1: signed.title }),
  ...
  if (finalized) {
    await prisma.notification.create({
      data: {
        ...
        type: "success",
        title: "Contrat actif",
        body: t("hr_contracts_votre_contrat_est_maintenant_signe_par_les_deux", { p0: finalized.title }),
        link: "/admin/mon-espace/contrats",
        icon: "check-circle",
      },
    }).catch(() => null);

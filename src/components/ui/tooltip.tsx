...
>(({ className, sideOffset = 4, collisionPadding = 8, avoidCollisions = true, ...props }, ref) => (
  // Portal : rend le tooltip dans <body>, JAMAIS dans le conteneur du trigger.
  // Sans ça, un tooltip à l'intérieur d'un DialogContent `overflow-hidden`
  // est rogné aux bords du dialog (bug historique des modaux).
